...
namespace UTIL
{
    ...
    uint8_t  extract_byte(uint64_t data, uint8_t idx)
    {
    ...
    uint16_t  extract_two_bytes(uint64_t data, uint8_t idx)
    {
    ...
    double  convert_uint64_to_double(uint64_t val)
    {
        DoubleExtract d;
    ...
    uint64_t  convert_double_to_uint64(double val)
    {
    ...
    uint8_t  check_double_equal(double lhs, double rhs)
    {
    ...
    DoubleDeconstructed  deconstruct_double(double val)
    {
    ...
    double  construct_double(struct DoubleDeconstructed dd, bool &okay)
    {
        okay = false;
